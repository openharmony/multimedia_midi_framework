...
uint8_t *MidiSharedMemoryImpl::GetBase() { return base_; }

size_t MidiSharedMemoryImpl::GetSize() { return size_; }

std::string MidiSharedMemoryImpl::GetName() { return name_; }

int MidiSharedMemoryImpl::GetFd() { return fd_; }
