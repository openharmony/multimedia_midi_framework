...
public:
    ...
    virtual OH_MIDIStatusCode OpenInputPort(OH_MIDIPortDescriptor descriptor, OH_OnMIDIReceived callback, void *userData);
    ...
    virtual OH_MIDIStatusCode Send(uint32_t portIndex, OH_MIDIEvent *events, uint32_t eventCount, uint32_t *eventsWritten);
